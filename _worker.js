...
let addresses = [
	'ssgxcfxip.zxc001.cloudns.org#otc',
	'cfip.xxxxxxxx.tk#otc',
	'www.visa.com.hk#HK',	
];

// 设置优选地址api接口
let addressesapi = [
	'https://apiipheji.cfx51559.workers.dev/', //可参考内容格式 自行搭建。
...
let subconverter = "https://hd.cfdnsjd.cloudns.org"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
